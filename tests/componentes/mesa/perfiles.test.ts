...
const perfil: Perfil = {
  ...
  ultimo: 'm2',
  mazos: [
    { id: 'm1', c: 'Muldrotha, the Gravetide', c2: '', col: 'UBG' },
    { id: 'm2', c: 'Thrasios, Triton Hero', c2: 'Kydele, Chosen of Kruphix', col: 'GU' },
  ],
}

describe('asientoDesde', () => {
  it('arrastra los dos comandantes y los colores del mazo', () => {
  ...
  it('sin mazo, deja el nombre solo', () => {
    expect(asientoDesde(perfil, null)).toEqual({ nombre: 'Marta', comandante: '', comandante2: '', colores: '' })
  })
})
